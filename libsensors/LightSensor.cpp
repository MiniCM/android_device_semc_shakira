...
/* The lightsensor for msm7x27 delivers 5 levels of light: 0, 4, 16, 64, 250 depending on the ambient light */
float LightSensor::indexToValue(size_t index) const
{
    static const float luxValues[5] = {
    		0, 4, 16, 64, 250
    };
